% Hartree-Fock Program to calculate the ground state energy of H2
...
% Hartree-Fock part (4.88)
% Need to modify f.m to match the index
Q2 = zeros(N,N,N,N); % 4-dimensional array
for p=1:N
    for q=1:N
        for r=1:N
            for s=1:N
                Q2(p,q,r,s)=2*Q(p,r,q,s)-Q(p,r,s,q);
            end
        end
    end
end
...
fprintf("The ground state energy of H2 molecule by Hartree Fock method (including nuclear repulsion +1) is %.8f Hartree.\n", E_G + 1);
