...
! KINETIC ENERGY
  ...
  PreFac = 2*PI*PI/BoxL**2*GridSize**3
  DO N = 1, N_orbitals
...
! SCF iterations
  IMPLICIT NONE
  INTEGER :: N, LDWork, INFO, Iter, MaxIter=45, Ielec, I, J, K
  ...
  DO Iter = 1, MaxIter
    ...
    print '(A15, 2F15.8)', 'eigenvalues', eigvals(1), eigvals(2)
    print '(A15, 2F15.8)', ' ',  eigvals(3), eigvals(4)
